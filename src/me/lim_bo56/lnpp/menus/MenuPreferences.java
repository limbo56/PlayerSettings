...
public class MenuPreferences extends AllStrings {
     ...
     public static void openPreferencesMenu(Player p) {
		...
		PreferencesMenu.setItem(11, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().PlayerPreferencesMenuItem), 1, 0, getInstance().PlayerPreferencesMenuName));
		// Player Preferences Item \\
		
		// Lobby Preferences Item \\
		PreferencesMenu.setItem(15, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().LobbyPreferencesMenuItem), 1, 0, getInstance().LobbyPreferencesMenuName));
		// Lobby Preferences Item \\
