	...
	public static Inventory PlayerPreferences;
		...
		public static void openPlayerPreferences(Player p) {
			...
			if(MainPreferences.getInstance().Speed.contains(p)) {
				...
				PlayerPreferences.setItem(19, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
				...
				PlayerPreferences.setItem(10, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().SpeedItem), 1, 0, getInstance().SpeedItemName));
				PlayerPreferences.setItem(19, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
			}
			//Speed Item\\
			...
			if(MainPreferences.getInstance().Jump.contains(p)) {
				...
				PlayerPreferences.setItem(21, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
				...
				l.add(getInstance().OffLore);
				PlayerPreferences.setItem(12, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().JumpItem), 1, 0, getInstance().JumpItemName));
				PlayerPreferences.setItem(21, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
			}
			//Jump Item\\		
			...
			PlayerPreferences.setItem(23, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
			...
			l.add(getInstance().OnLore);
			PlayerPreferences.setItem(14, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().FlyItem), 1, 0, getInstance().FlyItemName));
			PlayerPreferences.setItem(23, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
			}
			//Fly Item\\
			...
			PlayerPreferences.setItem(25, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
			...
			l.add(getInstance().OnLore);
			PlayerPreferences.setItem(16, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().VanishItem), 1, 0, getInstance().VanishItemName));
			PlayerPreferences.setItem(25, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
			}
			//Vanish Item\\
