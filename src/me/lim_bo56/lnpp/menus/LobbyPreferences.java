...
public class LobbyPreferences extends AllStrings {
     ...
     public static void openLobbyPreferences(Player p) {
    	 ...
    	 if(MainPreferences.getInstance().Stacker.contains(p)) {
    		 ...
    		 LobbyPreferences.setItem(20, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
    		 ...
    		 LobbyPreferences.setItem(11, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().StackerItem), 1, 0, getInstance().StackerItemName));
    		 LobbyPreferences.setItem(20, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
    	 }
    	 // Stacker Item \\
    	 ...
    	 if(MainPreferences.getInstance().Visibility.contains(p)) {
    		 ...
    		 LobbyPreferences.setItem(22, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
    		 ...
    		 l.add(getInstance().OnLore);
    		 LobbyPreferences.setItem(13, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().VisibilityItem), 1, 0, getInstance().VisibilityItemName));
    		 LobbyPreferences.setItem(22, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
    	 }
    	 // Visibility Item \\
    	 ...
    	 if(MainPreferences.getInstance().Chat.contains(p)) {
    		 ...
    		 LobbyPreferences.setItem(24, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 10, getInstance().On, l));
    		 ...
    		 l.add(getInstance().OnLore);
    		 LobbyPreferences.setItem(15, ItemFactory.getInstance().setItemNoLore(Material.getMaterial(getInstance().ChatItem), 1, 0, getInstance().ChatItemName));
    		 LobbyPreferences.setItem(24, ItemFactory.getInstance().setItemWithLore(Material.INK_SACK, 1, 8, getInstance().Off, l));
    	 }
    	 // Chat Item \\
