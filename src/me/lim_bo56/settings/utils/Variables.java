...
public class Variables {
    ...
    public static final PotionEffect INVISIBILITY = new PotionEffect(PotionEffectType.INVISIBILITY, 0, 10000000);
    public static final PotionEffect SPEED = new PotionEffect(PotionEffectType.SPEED, ConfigurationManager.getDefault().getInt("Speed.level"), 10000000);
    public static final PotionEffect JUMP = new PotionEffect(PotionEffectType.JUMP, ConfigurationManager.getDefault().getInt("Jump.level"), 10000000);
}