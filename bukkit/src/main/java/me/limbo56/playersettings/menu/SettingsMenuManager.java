...
public class SettingsMenuManager {
  ...
  private static final SettingsMenuItemRenderer MENU_BACK_RENDERER = new DismissRenderer();
  ...
  public void openMenu(SettingUser player, int page) {
    ...
    MENU_BACK_RENDERER.render(menuHolder, page);
  ...
  private static class SettingsMenuHolderLoader extends CacheLoader<UUID, SettingsMenuHolder> {
    ...
    @Override
    public @NotNull SettingsMenuHolder load(@NotNull UUID uuid) throws Exception {
