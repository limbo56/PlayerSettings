...
public class DatabaseField {
    ...
    public DatabaseField(String name, JDBCType type) {
        this(name, type, "");
    }

    public DatabaseField(String name, JDBCType type, String typeData) {
        this(name, type, typeData, new FieldConstraint[0]);
    }

    public DatabaseField(String name, JDBCType type, FieldConstraint... fieldConstraints) {
        this(name, type, "", fieldConstraints);
    }

    public DatabaseField(String name, JDBCType type, String typeData, FieldConstraint... fieldConstraints) {
        this.name = name;
        this.type = type;
